...
// Package v1alpha1 contains API Schema definitions for the gcpproviderconfig v1alpha1 API group
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=github.com/openshift/machine-api-provider-gcp/pkg/apis/gcpproviderconfig
// +k8s:defaulter-gen=TypeMeta
// +groupName=gcpproviderconfig.openshift.io
package v1alpha1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "gcpproviderconfig.openshift.io", Version: "v1alpha1"}
